...
import { Heart, GraduationCap, MessageSquare, Award, DollarSign, Target, FileText, Lightbulb, CheckCircle2, ExternalLink, AlertTriangle } from "lucide-react";
      ...
      <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
        ...
        <CardContent>
          <p className="text-muted-foreground leading-relaxed mb-4">
            A pesquisa de clima organizacional realizada no hospital administrado pela AEBES (Associação Evangélica Beneficente Espírito-Santense) revelou pontos de destaque e áreas críticas relacionadas à percepção dos colaboradores sobre o ambiente de trabalho, liderança, reconhecimento e desenvolvimento profissional.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Com base nessas evidências e nas melhores práticas internacionais, este plano de ação tem como objetivo traduzir os achados da pesquisa em medidas concretas de melhoria organizacional, promovendo engajamento, satisfação e desempenho sustentável.
          </p>
        </CardContent>
      </Card>

      {/* Abas com os blocos */}
      <Tabs defaultValue="bem-estar" className="w-full">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 mb-6 gap-2">
          <TabsTrigger value="bem-estar" className="text-xs sm:text-sm">Bem-Estar</TabsTrigger>
          <TabsTrigger value="desenvolvimento" className="text-xs sm:text-sm">Desenvolvimento</TabsTrigger>
          <TabsTrigger value="comunicacao" className="text-xs sm:text-sm">Comunicação</TabsTrigger>
          <TabsTrigger value="reconhecimento" className="text-xs sm:text-sm">Reconhecimento</TabsTrigger>
          <TabsTrigger value="remuneracao" className="text-xs sm:text-sm">Remuneração</TabsTrigger>
          <TabsTrigger value="carreira" className="text-xs sm:text-sm">Carreira</TabsTrigger>
        </TabsList>
